...
class BH_Move_Admin_Page {
	...
	public static function add_menu_page() {
		...
		$title = __( 'Bluehost Move', 'bluehost-move' );
	...
	public static function render_page() {
		...
		wp_localize_script(
			...
			'BHMove',
			array(
				'isCompatible' => BH_Move_Options::get( 'isCompatible' ),
				'isComplete'   => BH_Move_Options::get( 'isComplete' ),
				'restNonce'    => wp_create_nonce( 'wp_rest' ),
				'pluginUrl'    => plugins_url( '/', dirname( __FILE__ ) ),
				'restRootUrl'  => esc_url_raw( rest_url() ),
			)
		);
		echo '<div id="bluehost-move"></div>';
	}
