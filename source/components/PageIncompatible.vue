<template>
	<div class="page --incompatible">
		...
		<div class="content">
			...
			<p>{{__("Give us a call at 800-XXX-XXXX.", 'bluehost-move')}}</p>
...
<script>
	export default {
		data() {
			return {
				imageSrc: window.BHMove.pluginUrl + require('@/images/computer-transfer-broken.svg').default
			}
		}
	}
</script>
