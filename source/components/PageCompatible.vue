<template>
	<div class="page --compatible">
		<div class="content">
			...
			<router-link class="button" to="/transfer" tag="button">{{__("Start Transfer", 'bluehost-move')}}</router-link>
		</div>
...
<script>
	export default {
		data() {
			return {
				imageSrc: window.BHMove.pluginUrl + require('@/images/computer-transfer.svg').default
			}
		}
	}
</script>
